...
from code.const import WINDOW_WIDTH, WINDOW_HEIGHT, C_GRAY, C_GOLD
...
class Victory:
    def __init__(self, window, last_frame):
        ...
        self.text_alpha = 0
        self.victory_sound = pygame.mixer.Sound('./assets/win.mp3')
    ...
    def run(self):
        ...
        while True:
            ...
            if self.text_alpha:
                self.draw_fade_text('ENEMY DEFEATED', 90, C_GOLD, (WINDOW_WIDTH // 2, WINDOW_HEIGHT // 2 - 50),
                                    self.text_alpha)
